-- Allow guardians and profile owners to delete their child_profiles record.

drop policy if exists "child profiles delete by guardian" on public.child_profiles;

create policy "child profiles delete by guardian or owner"
