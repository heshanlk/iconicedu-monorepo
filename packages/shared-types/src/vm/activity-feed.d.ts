...
export type ActivityGroupKeyVM = 'homework' | 'message' | 'class' | 'reminder' | 'recording' | 'notes' | 'ai-summary' | 'payment' | 'survey' | 'complete-class';
...
export type ActivityVerbVM = 'class.created' | 'class.updated' | 'session.scheduled' | 'session.rescheduled' | 'session.canceled' | 'session.completed' | 'message.posted' | 'message.edited' | 'message.deleted' | 'reaction.added' | 'reaction.removed' | 'homework.assigned' | 'homework.submitted' | 'homework.reviewed' | 'summary.posted' | 'notes.posted' | 'file.uploaded' | 'file.deleted' | 'member.invited' | 'member.joined' | 'member.removed' | 'role.changed';
export type InboxTabKeyVM = 'all' | 'classes' | 'payment' | 'system';
export type InboxIconKeyVM = 'Bell' | 'CheckCircle2' | 'ClipboardCheck' | 'CreditCard' | 'FileText' | 'GraduationCap' | 'MessageSquare' | 'Paperclip' | 'Sparkles' | 'Video';
