...
export type CalendarVisibilityVM = 'private' | 'internal' | 'class-members' | 'public';
export type CalendarColorTokenVM = 'blue' | 'pink' | 'green' | 'yellow' | 'orange' | 'purple' | 'gray';
...
export interface RecurrenceOverrideVM {
    ...
    patch: Partial<Pick<CalendarEventVM, 'title' | 'description' | 'location' | 'startAt' | 'endAt' | 'status' | 'participants' | 'color' | 'visibility' | 'source'>>;
}
