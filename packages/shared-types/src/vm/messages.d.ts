...
export type MessageTypeVM = 'text' | 'image' | 'file' | 'design-file-update' | 'payment-reminder' | 'event-reminder' | 'lesson-assignment' | 'progress-update' | 'session-booking' | 'homework-submission' | 'link-preview' | 'audio-recording';
...
export type MessageVM = TextMessageVM | ImageMessageVM | FileMessageVM | DesignFileUpdateMessageVM | PaymentReminderMessageVM | EventReminderMessageVM | LessonAssignmentMessageVM | ProgressUpdateMessageVM | SessionBookingMessageVM | HomeworkSubmissionMessageVM | LinkPreviewMessageVM | AudioRecordingMessageVM;
export {};
