import type { CalendarEvent, CalendarView, RecurrenceRule } from '@iconicedu/shared-types';
...
export const getCalendarEventsForView = (
  ...
  const rangeStart = view === 'week' ? getWeekStart(currentDate) : startOfDay(currentDate);
