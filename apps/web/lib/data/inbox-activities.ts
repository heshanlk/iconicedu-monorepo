...
import { getMockChildNameByAccountId, MOCK_CHILDREN_IDS } from './people';
...
export const INBOX_ACTIVITIES: InboxActivityInput[] = [
  ...
  },
  {
    ...
    studentName: getMockChildNameByAccountId(MOCK_CHILDREN_IDS.zayne),
    participants: [
      {
        avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=dinesha',
        initials: 'MD',
  ...
  },
  {
    ...
    iconKey: 'GraduationCap',
    iconBg: 'bg-blue-500 text-white',
    studentName: getMockChildNameByAccountId(MOCK_CHILDREN_IDS.sophia),
    participants: [
