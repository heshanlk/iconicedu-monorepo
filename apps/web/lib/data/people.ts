...
export const MOCK_EDUCATOR_1: EducatorProfileVM = {
  ...
  gradesSupported: [{ id: 4, label: 'Grade 4' }, { id: 5, label: 'Grade 5' }],
...
export const MOCK_EDUCATOR_2: EducatorProfileVM = {
  ...
  gradesSupported: [{ id: 3, label: 'Grade 3' }, { id: 4, label: 'Grade 4' }],
  education: 'B.S., Applied Mathematics',
  experienceYears: 8,
  certifications: [{ name: 'Math Instruction Credential', issuer: 'State Board', year: 2018 }],
...
export const MOCK_EDUCATOR_4: EducatorProfileVM = {
  ...
  gradesSupported: [{ id: 3, label: 'Grade 3' }, { id: 6, label: 'Grade 6' }],
